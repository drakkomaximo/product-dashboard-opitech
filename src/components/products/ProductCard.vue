    ...
    <article class="flex h-full flex-col">
      ...
      <div class="flex flex-1 flex-col px-4 py-3">
        ...
        <div class="mt-3 flex items-center justify-between text-xs">
          <span
            class="inline-flex items-center rounded-full border border-slate-700 bg-slate-900 px-2 py-0.5 text-[11px] font-medium uppercase tracking-wide text-slate-300">
            {{ product.category }}
          </span>
